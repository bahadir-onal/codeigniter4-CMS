                        ...
                        <div class="card">
                            ...
                            <form action="<?= current_url() ?>" method="POST">
                                            ...
                                            <div class="tab-pane fade <?= $key == 0 ? 'show active' : ''; ?>" id="<?= $lang->getCode(); ?>" role="tabpanel" aria-labelledby="<?= $lang->getCode(); ?>-tab">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?= $group->getTitle($lang->getCode()) ?>"
                                                           name="title[<?= $lang->getCode(); ?>]" type="text"
                                                           class="form-control"
                                            ...
                                            <?php foreach (config('permissions')->list as $pkey => $pvalue) { ?>
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                    ...
                                                    <label class="custom-switch mt-2">
                                                        <input
                                                                type="checkbox" name="permission[<?= $pkey ?>]"
                                ...
                                <div class="card-footer text-right">
                                    <button type="submit" class="btn btn-primary btn-block btn-lg"><?= bo_admin_translate('Groups','update_btn'); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
